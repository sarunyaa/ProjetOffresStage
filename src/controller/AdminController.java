...
//
//	/**************** Informations affichées sur la droite *****/
//	@FXML
//	private TitledPane informations;
//
//	@FXML
...
//
//	@FXML
//    void afficherInfosEtu(MouseEvent event) {
//		
//	/*	Etudiant e = new Etudiant();
//		int id = e.getIdEtudiant();
//		tableVetudiant.getSelectionModel().select(id);
//		EtudiantDao et = new EtudiantDao();
//		et.selectionner(id).equals(e);  */
//
//		Etudiant e = tableVetudiant.getSelectionModel().getSelectedItem();
//		id1.setText(e.getNom());
//		id2.setText(e.getPrenom());
//		id3.setText(e.getDateDeNaissance().toString());
//		id4.setText(e.getNiveauEtude());
//		id5.setText(e.getAdresseMail());
//
//    }
//	
//
//	@FXML
//	void modifierInfos(ActionEvent event) {
//
//	}
//
//
...
//				String telEntreprise= rs.getString("telEntreprise");
//				String secteurActivite= rs.getString("secteurActivité");
//
//
//			//	listeEnt.add(new Entreprise(idEntreprise,raisonSociale, adresseRue, adresseVille, adresseCodePostal, telEntreprise,secteurActivite));
...
//				Date ddnEtudiant  = rs.getDate("dateDeNaissance");
...
//
//
//				listeEt.add(new Etudiant(idEtudiant,nomEtudiant, prenomEtudiant, ddnEtudiant, nivEtude, mailEtudiant) );
//			}
//		} catch (SQLException e) {
//			e.printStackTrace();
//		}
...
public class AdminController implements Initializable{
	...
	alert.setContentText("Etudiant supprimé de la base de données");
	alert.showAndWait();
	...
	void listEntreprise(){
		...
		try {
			...
			while(rs.next()){
				...
				//	listeEnt.add(new Entreprise(idEntreprise,raisonSociale, adresseRue, adresseVille, adresseCodePostal, telEntreprise,secteurActivite));
				listeEnt.add(new Entreprise(raisonSociale, adresseRue, adresseVille, adresseCodePostal,mailEntreprise, telEntreprise,secteurActivite));
	...
	//			rs.last();
	//			String prenom = rs.getString("login");
	//		//	Blob photo = rs.getBlob(photo);
	//
	//
	//	//		nomAdmin.setText(prenom);
	//
	//		}catch(Exception e){
	//			e.printStackTrace();
	//		}
	...
	private void loadChart(ActionEvent event){
		String sql = "SELECT dateDeNaissance FROM Etudiant ORDER BY idEtudiant";
		...
		try{
			...
			while(rs.next()){
				series.getData().add(new XYChart.Data<>(rs.getString("DateDeNaissance"), rs.getInt("idEtudiant")));
